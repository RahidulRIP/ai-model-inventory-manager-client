...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F7FE] font-sans text-slate-900">
      {/* 1. EXCEPTIONAL BLUR OVERLAY (Visible on Mobile) */}
      {isSidebarOpen && (
        <div
      ...
      <div className="flex p-0 md:p-4 lg:p-6 gap-0 md:gap-6">
        {/* 2. THE FLOATING SIDEBAR (Glassmorphism) */}
        <aside
          className={`
        ...
        >
          ...
          <nav className="px-4 mt-6 space-y-3">
            ...
            <NavLink to="announcement" className={navLinkStyles}>
              <RiMegaphoneLine size={22} />
              <span className="font-bold tracking-wide">Announcements</span>
            </NavLink>

            <NavLink to="dashboard-overview" className={navLinkStyles}>
